...
Gem::Specification.new do |s|
  ...
  s.date = %q{2010-06-18}
  s.description = %q{It's a small library (5.2KB or 1.76KB when gzipped) to provide the Rails I18n translations on the Javascript.}
  ...
  s.summary = %q{It's a small library (5.2KB or 1.76KB when gzipped) to provide the Rails I18n translations on the Javascript.}
  s.test_files = [
    "test/i18n_js_test.rb",
     "test/test_helper.rb"
  ]
